...
export function SlideSidebar({
  deckSlug, slides, current, thumbnails, generatingThumbs, onGoTo, onReorder, onTitleEdit, onClose, onRegenerateThumbnails, onAddSlide, onDeleteSlides, onToggleSkips }: SlideSidebarProps) {
  ...
  useEffect(() => {
    ...
    const delayDebounceFn = setTimeout(() => {
      ...
      const currentDeckSlug = slides[0]?.deck_slug || deckSlug;
